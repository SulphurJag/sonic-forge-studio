	...
	theme: {
		...
		extend: {
			colors: {
                ...
                // Custom colors for Moroder Audio Mastering Suite
                moroder: {
                    dark: '#1A1F2C',
                    primary: '#9b87f5',
                    light: '#D6BCFA',
